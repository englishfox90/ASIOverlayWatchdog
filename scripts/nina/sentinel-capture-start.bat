...
REM start PFR Sentinel capture. See README.md in this folder.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Invoke-SentinelCapture.ps1" -Command start
exit /b %ERRORLEVEL%
